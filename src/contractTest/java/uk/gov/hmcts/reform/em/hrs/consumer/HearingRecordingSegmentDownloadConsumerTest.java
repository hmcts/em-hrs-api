...
public class HearingRecordingSegmentDownloadConsumerTest extends BaseConsumerPactTest {

    private static final String PROVIDER = "em_hrs_api_segment_download_provider";
    private static final String CONSUMER = "em_hrs_api_segment_download_consumer";
    ...
    public V4Pact downloadSegmentBySegmentNoPact(PactDslWithProvider builder) {
        return buildPact(
            builder,
            "A segment exists to download by recording ID and segment number",
