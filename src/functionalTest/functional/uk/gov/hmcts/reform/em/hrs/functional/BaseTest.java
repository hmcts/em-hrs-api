...
import uk.gov.hmcts.reform.em.hrs.functional.config.AuthTokenGeneratorConfig;
import uk.gov.hmcts.reform.em.hrs.functional.config.CcdAuthTokenGeneratorConfig;
...
import uk.gov.hmcts.reform.em.hrs.functional.config.TestUtil;
...
@SpringBootTest(classes = {
    ...
    EmTestConfig.class,
    CcdAuthTokenGeneratorConfig.class,
    AuthTokenGeneratorConfig.class,
    TestUtil.class,
